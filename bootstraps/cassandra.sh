...
sudo mkdir -p /data/cassandra/data /data/cassandra/commitlog
sudo chmod -R ugo+rw /data/cassandra
bash $bootstraps/set_opt.sh /etc/cassandra/cassandra.yaml 'commitlog_directory:' ' /data/cassandra/commitlog'
